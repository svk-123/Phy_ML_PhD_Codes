...
data_file='cp_foil_1600_dist_300.pkl'
...
my_inp=np.reshape(my_inp,(len(my_inp),216,216,1))
...
for k in range(200):
    ...
    plt.plot(xx,my_out[k+100][0:35],'ro',label='true')
    plt.plot(xx,my_out[k+100][35:],'ro')
    ...
    #plt.axis('off')
    plt.tight_layout()
    plt.savefig('./plot_out_dist_tr/ts_%s_%s.png'%(k+100,name[k]))
    plt.show()
