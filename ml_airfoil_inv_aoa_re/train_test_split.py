...
for ii in [1,2,3,4,5,7,8,9,10]:
    ...
    outpath='./foil_all_re_aoa/data_files_train_test/'
    
    data1=[tr_val0, tr_val1, tr_val2, tr_val3, tr_val4, tr_val5, tr_val6, tr_val7, tr_val8, val9]
    with open(outpath+'data_re_aoa_fp_tr_%s.pkl'%ii, 'wb') as outfile:
    ...
    with open(outpath+'data_re_aoa_fp_ts_%s.pkl'%ii, 'wb') as outfile:
