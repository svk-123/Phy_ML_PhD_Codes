...
for ii in [1]:
    data_file='./data_file/naca4_lam_clcd_3para.pkl'
...
model_test=load_model('./selected_model/3para_6x30/model_sf_1500_0.00041091_0.00041618.hdf5') 
