...
# ref:[data,name]
path='./data_file/'
data_file='foil_param_naca4_opti_0.pkl'
...
model=load_model('./selected_model/case_1_p8_naca4_C5F7/model_cnn/final_cnn.hdf5')   
...
for i in range(8):
    print ("max-min-%d: %f - %f " %(i, c1[:,i].max(),c1[:,i].min() ) )    
    
info='[para,name,info-noscaling]'    
data2=[c1,name,info]
with open(path+'param_216_tanh_naca4_v1.pkl', 'wb') as outfile:
