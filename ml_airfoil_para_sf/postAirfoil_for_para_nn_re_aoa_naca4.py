...
datafile='./data_file/naca4_digit_para.pkl'
...
for jj in range(3):
    ...
    info=['myinp_x, myinp_y, myinp_para, myinp_re, myinp_aoa, myout_p, myout_u, myout_v, coord, mynae, scaler,info[p-corr]']

    data1 = [myinp_x, myinp_y, myinp_para, myinp_re, myinp_aoa, myout_p, myout_u, myout_v, coord, myname,scaler, info ]

    with open(filepath+'/foil_naca4_lam_%s.pkl'%(jj+1), 'wb') as outfile1:
