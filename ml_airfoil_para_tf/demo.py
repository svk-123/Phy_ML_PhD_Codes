...
class PhysicsInformedNN:
    ...
    def __init__(self, x, y,rst=False):
        ...
        self.y_pred = self.net_NS(self.y_tf)
    ...
    def neural_net(self, X):
        ...
        #create model
        fc1= tf.layers.dense(X, 10, activation=tf.nn.tanh)
        fc2= tf.layers.dense(fc1, 10, activation=tf.nn.tanh,name='para')        
        Y = tf.layers.dense(fc2, 70,name='prediction')
