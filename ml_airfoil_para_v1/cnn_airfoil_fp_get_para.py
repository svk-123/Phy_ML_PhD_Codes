...
path='./data_file/'
data_file='foil_naca4_opti_0.pkl'
...
model=load_model('./selected_model/case_1_p8_tanh_include_naca4_v2/model_cnn/final_cnn.hdf5') 
...
info='[para(unscaled),name,xx,info: naca4, uiuc and gan 0p5 foils included: total 5k+ ]'    
data2=[c1,name,xx,info]
with open(path+'cnn_naca4_para_8_tanh_v1.pkl', 'wb') as outfile:
