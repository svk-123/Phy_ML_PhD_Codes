...
#replace GAN para
path='./data_file/'
data_file='cnn_naca4_para_8_tanh_v1.pkl'
...
for ii in [1]:
    ...
    data_file='./database_gen_naca4/naca4_clcd_turb_st_8para.pkl'
...
with open(path+'/naca4_cnn_clcd_turb_8para_v1.pkl', 'wb') as outfile1:
