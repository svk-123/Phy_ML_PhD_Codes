...
class AdversarialAutoencoder():
    ...
    def build_encoder(self):
        ...
        conv4 = Conv2D(256, (4, 4), activation='relu', padding='same')(pool3)
    ...
    def train(self, epochs, batch_size=32, sample_interval=50):
        ...
        data_file='../ml_airfoil_para/data_file/'	
        for ii in range(1,3):
            with open(data_file + 'foil_param_aug_%s.pkl'%ii, 'rb') as infile:
...
if __name__ == '__main__':
    ...
    aae.train(epochs=18*5000, batch_size=64, sample_interval=100)
