...
class AdversarialAutoencoder():
    ...
    def train(self, epochs, batch_size=32, sample_interval=50):
		...
		latent_fake[:,0:4]=latent_fake[:,0:4]*-1                
                ...
                if ((epoch+1) % 100 == 0 and batch == nbatches-2 and self.my_lr > 1.e-6):
                    self.my_lr=self.my_lr*0.5
    
                if ((epoch+1) % 100 == 0 and batch == nbatches-2):                
...
if __name__ == '__main__':
    ...
    aae.train(epochs=2000, batch_size=32, sample_interval=100)
