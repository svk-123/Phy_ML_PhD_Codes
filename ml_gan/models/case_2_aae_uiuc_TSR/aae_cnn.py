...
class AdversarialAutoencoder():
    ...
    def build_encoder(self):
        ...
        flat5 = Dense(200, activation='tanh')(flat5)
        flat5 = Dense(200, activation='sigmoid')(flat5)
        latent_repr = Dense(self.latent_dim, activation='relu')(flat5)
    ...
    def save_model(self,I):
        ...
        def save(model, model_name):
            model_path = "saved_model/%s_%s.json" % (model_name,I)
            weights_path = "saved_model/%s_weights_%s.hdf5" % (model_name,I)
        ...
        save(self.adversarial_autoencoder, "aae_generator_%s"%I)
        save(self.discriminator, "aae_discriminator_%s"%I)
        save(self.encoder, "aae_encoder_%s"%I)
        save(self.decoder, "aae_decoder_%s"%I)

if __name__ == '__main__':
    aae = AdversarialAutoencoder()
    aae.train(epochs=100000, batch_size=32, sample_interval=100)
