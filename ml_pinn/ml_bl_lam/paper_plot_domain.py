...
#sampling
xyu_s1=np.loadtxt(path + 'bl_sample_x8.dat',skiprows=1)
xyu_s2=np.loadtxt(path + 'bl_sample_x8.dat',skiprows=1)

#xyu_s1=np.loadtxt(path + 'bl_sample_x8_0p8.dat',skiprows=1)
#xyu_s2=np.loadtxt(path + 'bl_sample_x8_0p10.dat',skiprows=1)  
...
plt.subplot(1,2,1)
plt0, =plt.plot(xyu_s1[:,0:1],xyu_s1[:,1:2]+0.45,'og',linewidth=0,ms=4,label='MSE internal pts: 54 ',zorder=8)
plt0, =plt.plot(xyu_wall[:,0:1],xyu_wall[:,1:2],'ok',linewidth=0,ms=3,label='MSE BC pts: 800',zorder=5)
plt0, =plt.plot(xyu_outlet_r[:,0:1]-5,xyu_outlet_r[:,1:2],'ok',linewidth=0,ms=3,zorder=5)
plt0, =plt.plot(xyu_outlet_t[:,0:1],xyu_outlet_t[:,1:2],'ok',linewidth=0,ms=3,zorder=5)
plt0, =plt.plot(xyu_outlet_r[:,0:1],xyu_outlet_r[:,1:2],'ok',linewidth=0,ms=3,zorder=5)
...
plt.text(2.5, 3.3, "Outlet: p=0", horizontalalignment='center', verticalalignment='center')
plt.text(-0.3, 1.5, "Inlet: u-specified", horizontalalignment='center', verticalalignment='center',rotation=90)
plt.figtext(0.3, -0.08, '(a) S-A', wrap=True, horizontalalignment='center', fontsize=16)
plt.xlabel('X',fontsize=20)
plt.ylabel('Y',fontsize=20)
plt.xlim(-1,6)
plt.ylim(-1,4)   
...
plt.subplot(1,2,2)
plt0, =plt.plot(xyu_s2[:,0:1],xyu_s2[:,1:2]+0.7,'og',linewidth=0,ms=4,label='MSE internal pts: 54 ',zorder=8)
plt0, =plt.plot(xyu_wall[:,0:1],xyu_wall[:,1:2],'ok',linewidth=0,ms=3,label='MSE BC pts: 800',zorder=5)
plt0, =plt.plot(xyu_outlet_r[:,0:1]-5,xyu_outlet_r[:,1:2],'ok',linewidth=0,ms=3,zorder=5)
plt0, =plt.plot(xyu_outlet_t[:,0:1],xyu_outlet_t[:,1:2],'ok',linewidth=0,ms=3,zorder=5)
plt0, =plt.plot(xyu_outlet_r[:,0:1],xyu_outlet_r[:,1:2],'ok',linewidth=0,ms=3,zorder=5)
...
plt.text(2.5, 3.3, "Outlet: p=0", horizontalalignment='center', verticalalignment='center')
plt.text(-0.3, 1.5, "Inlet: u-specified", horizontalalignment='center', verticalalignment='center',rotation=90)
plt.figtext(0.73, -0.08, '(b) S-B', wrap=True, horizontalalignment='center', fontsize=16)
plt.xlabel('X',fontsize=20)
#plt.ylabel('Y',fontsize=20)
plt.xlim(-1,6)
plt.ylim(-1,4) 
...
plt.xlim(-1,6)
plt.ylim(-1,4)    
plt.savefig('./plot/mesh_diff_sampp.tiff', format='tiff',bbox_inches='tight', dpi=300)
plt.show()