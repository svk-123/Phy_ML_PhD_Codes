...
for ii in range(A,A+1):
    ...
    with open('./data_file/foil_naca0012_Re2000to3000_aoa_0to16_test.pkl', 'rb') as infile:
...
with tf.Session() as sess1:
    ...
    path1='./tf_airfoil/case_2_50pts_8x100/tf_model/'
...
with tf.Session() as sess2:
    ...
    path2='./tf_airfoil/case_2_nn_50pts_8x100/tf_model/'
