...
if __name__ == "__main__": 
    ...
    for ii in range(1):
        #x,y,Re,u,v
        with open('../data_file/naca4518_2000_14_wake.pkl', 'rb') as infile:
    ...
    for ii in range(1):
        #x,y,Re,u,v
        with open('../data_file/naca4518_2000_14_all10.pkl', 'rb') as infile:
            result = pickle.load(infile)
    ...
    #import wall bc
    xyu=np.loadtxt('../data_file/af_wall_200.dat')
    
    xyu_io=np.loadtxt('../data_file/af_inout_50.dat')
    ...
    ub_train = np.concatenate((xyu[:,2:3], xyu_io[:,2:3]),axis=0)
    vb_train = np.concatenate((xyu[:,3:4], xyu_io[:,3:4]),axis=0)
