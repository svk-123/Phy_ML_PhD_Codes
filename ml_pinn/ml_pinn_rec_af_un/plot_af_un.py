...
#load data
xy=np.loadtxt('./data_file/naca0012_200_30_1211_t_24_25_dt_0p05_nt_21/naca0012_internal_1211.dat',skiprows=1)
...
co=np.loadtxt('./data_file/naca0012_200_30_1211_t_24_25_dt_0p05_nt_21/naca0012_wall_300.dat',skiprows=1)
co=co[:360,:]
...
with tf.Session() as sess1:
    ...
    path1='./tf_model/case_1_rand_3000_30000/tf_model/'
    new_saver1 = tf.train.import_meta_graph( path1 + 'model_90000.meta')
...
#open pdf file
#fp= PdfPages('./plot/plots_turb_ts_%s.pdf'%tttt)
...
def con_plot():
    ...
    plt.savefig('./plot/cy_%s.png'%tttt,format='png',bbox_inches='tight',dpi=300)
    plt.close()
...
def plot_cp():
    ...
    #plt.subplots_adjust(top = 0.8, bottom = 0.1, right = 0.9, left = 0.0, hspace = 0.0, wspace = 0)
    plt.savefig('./plot/cp_%s.png'%tttt,format='png',bbox_inches='tight', dpi=100)
    plt.show()
...
def line_plotu_sub(i):
    ...
    plt.savefig('./plot/u_%s.png'%(tttt), format='png', bbox_inches='tight',dpi=100)
    plt.show()   
    plt.close()
    ...
    plt.savefig('./plot/v_%s.png'%(tttt), format='png',bbox_inches='tight', dpi=100)
    plt.show() 
    plt.close()    
