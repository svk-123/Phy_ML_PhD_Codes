...
if __name__ == "__main__": 
    ...
    #sampling
    xyu_s=np.loadtxt(path + 'naca0012_sample_ar_30x4.dat',skiprows=1)
...
#plt0, =plt.plot(xyu_s[:,0],xyu_s[:,1],'og',linewidth=0,ms=3,label='MSE internal pts: 120 ',zorder=8)
#
##
####text-1
