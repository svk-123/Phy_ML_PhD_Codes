...
mylabel=['CFD','PINN','PINN_2222_3S_wake_80','PINN_2222_4S_around_80','PINN_5555_4S_around_80']
...
for jj in range(2):
        ...
        with open('./cy_ml/%s/321/wallShearStress'%(tmp[jj]), 'r') as infile:
...
plt.savefig('./plot/cy_tau.png', bbox_inches='tight',dpi=100)
plt.show()          
