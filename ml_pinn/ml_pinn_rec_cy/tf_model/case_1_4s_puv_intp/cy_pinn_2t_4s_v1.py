...
4s - indicates puv specified both inner and outer Bound. intp. CFD.
"""
'''
...
class PhysicsInformedNN:
    ...
    def __init__(self, x, y, u, v, p, xg, yg, rst=False):
...
if __name__ == "__main__": 
    ...
    #import wall bc
    #x,y,p,u,v
    xyu_io=np.loadtxt('../data_file/cy_outer_4s_3333_cfd_intp.dat',skiprows=1)
    ...
    xyu_in=np.loadtxt('../data_file/cy_internal_3333.dat',skiprows=1)    
    ...
    # Training
    model = PhysicsInformedNN(x_train, y_train, u_train, v_train, p_train, xg_train, yg_train, False)
