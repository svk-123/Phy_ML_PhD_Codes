...
#                    tf.reduce_sum(tf.square(self.f_v_pred))
	...
	self.lb_count=0
        ...
        if(rst == True):
            self.saver.restore(self.sess, tf.train.latest_checkpoint('./tf_model_2/'))
...
if __name__ == "__main__": 
    ...
    # Training
    model = PhysicsInformedNN(x_train, y_train, t_train,  u_train, v_train, p_train, xb_train, yb_train, tb_train, ub_train, vb_train, xg_train, yg_train, tg_train, False)
