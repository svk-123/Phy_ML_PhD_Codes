...
plt.legend(loc='upper center', bbox_to_anchor=(1.5, 1), ncol=1, frameon=False, fancybox=False, shadow=False,fontsize=16)
plt.xlim(0,1)
plt.ylim(0,1)    
plt.savefig('./plot/mesh1.tiff', format='tiff',bbox_inches='tight', dpi=300)
plt.show()
