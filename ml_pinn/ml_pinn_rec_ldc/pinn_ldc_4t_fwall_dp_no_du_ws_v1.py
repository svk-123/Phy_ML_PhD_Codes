...
class PhysicsInformedNN:
    ...
    def __init__(self, x, y, p, u, v, \
        ...
        self.p_iw_tf = tf.placeholder(tf.float32, shape=[None, self.u_iw.shape[1]])
        ...
        #MSE wall
        self.u_iw_pred, self.v_iw_pred, self.p_iw_pred, _= self.net_NS1(self.x_iw_tf, self.y_iw_tf,self.nx_iw_tf, self.ny_iw_tf)
...
#                    tf.reduce_sum(tf.square(self.f_v_pred))
        ...
        self.loss_1 = tf.reduce_mean(tf.square(self.u_iw_tf - self.u_iw_pred)) + \
                        ...
                        tf.reduce_mean(tf.square(self.p_iw_tf - self.p_iw_pred))
        ...
        while(count < nIter):
            ...
            for i in range(1):
                ...
                tf_dict = {self.x_tf: self.x, self.y_tf: self.y, self.u_tf: self.u, self.v_tf: self.v, self.p_tf: self.p, \
                           self.x_iw_tf: self.x_iw, self.y_iw_tf: self.y_iw, self.p_iw_tf: self.p_iw, self.u_iw_tf: self.u_iw, self.v_iw_tf: self.v_iw, \
...
if __name__ == "__main__": 
    ...
    #sampling
    xyu_s=np.loadtxt(path + 'ldc_sample_x9_5.dat',skiprows=1)
