...
#load_model
model_test=load_model('./selected_model/Re1000-10000_y/model_sf_1500_0.000172_0.000166.hdf5') 
...
def line_plot1():
    ...
    plt0, =plt.plot(u2a,ya,'r',linewidth=3,label='NN-local')
    plt0, =plt.plot(u2a1,ya,'b',linewidth=3,label='NN')
...
def line_plot2():
    ...
    plt0, =plt.plot(xb,v2a,'r',linewidth=3,label='NN-local')   
    plt0, =plt.plot(xb,v2a1,'b',linewidth=3,label='NN')  
    plt.legend(fontsize=20)
...
model_test1=load_model('./selected_model/Re1000-10000/final_sf.hdf5') 
