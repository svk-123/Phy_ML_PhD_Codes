...
plt.legend(loc="upper left", bbox_to_anchor=[1, 0.8], ncol=2, fontsize=12, \
           frameon=False, shadow=False, fancybox=False,title='')
plt.text(40000*1.05,1.0,'Initial $C_L$',fontsize=16)
plt.text(40000*1.25,1.0,'Pred $C_L$',fontsize=16)
...
plt.legend(loc="upper left", bbox_to_anchor=[1, 0.8], ncol=2, fontsize=12, \
           frameon=False, shadow=False, fancybox=False,title='')
plt.text(40000*1.05,0.08,'Initial Cd',fontsize=16)
plt.text(40000*1.25,0.08,'Pred Cd',fontsize=16)
plt.xticks(reno) 
#plt.xlim([-0.05,30])
#plt.ylim([-0.05,1.1])
plt.xlabel('Re',fontsize=20)
